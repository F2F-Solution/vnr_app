...
var KTSignupGeneral=function(){
    ...
    return{
        init:function(){
            ...
            {fields:
                {
                    "username":{validators:{notEmpty:{message:"Name + required"}}},
                    "last-name":{validators:{notEmpty:{message:"Last Name is required"}}},
                    "phone-number":{validators:{notEmpty:{message:"Number is required"}}},
                    "gender":{validators:{notEmpty:{message:"gender is required"}}},
                    //  "image":{validators:{notEmpty:{message:"image is required"}}},
