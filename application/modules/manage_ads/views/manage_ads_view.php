                                    ...
                                    <div class="row">
										...
										<div class="col-md-9">
											<div class="fv-row mb-10">
												...
												<textarea class="form-control form-control-lg form-control-solid validation" name="content" rows="4" id="content" ></textarea>
                                    ...
                                    <div class="row">
										...
										<div class="col-md-9">
											<div class="fv-row">
												...
												<textarea class="form-control form-control-lg form-control-solid" name="content" id="content1" rows="5" ></textarea>
    ...
    table = $("#user_data").DataTable({
      ...
      event.preventDefault();
        ...
        if (result.isConfirmed) {
			$.ajax({
				url: "<?php echo base_url() . 'manage_ads/delete';?>",
				type: 'POST',
				data:{id:id},
