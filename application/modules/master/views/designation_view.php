...
<div class="card-body pt-0">
    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        $sno++; 
            ?></td>  
            <td>
            <a class="btn btn-info btn-sm"  data-bs-toggle="modal" data-bs-target="#kt_modal_edit_user" href="<?php echo base_url('master/designation/edit/'.$row->iDesignationId)?>"><i class="fa fa-edit"></i></a>
            <a  class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('master/designation/delete/'.$row->iDesignationId) ?>"> <i class="fa fa-trash"></i></a>
