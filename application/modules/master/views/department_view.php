    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        <tbody class="text-gray-600 fw-bold">
         ...
         {  
            ...
            ?></td>  
            <td>
            <a class="btn btn-info btn-sm"  data-bs-toggle="modal" data-bs-target="#kt_modal_edit_user" href="<?php echo base_url('master/department/edit/'.$row->iDepartmentId)?>"><i class="fa fa-edit"></i></a>
            <a  class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('master/department/delete/'.$row->iDepartmentId) ?>"> <i class="fa fa-trash"></i></a>
