...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Department
            ...
            <!--begin::Table-->
                  <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <!--begin::Table row-->
                                        ...
                                        ?><tr>  
                                        <td><?php echo $sno; ?></td>  
                                        <td><?php echo $row->vDepartmentName;?></td>  
                                        <td><?php 
                                        if ($row->tStatus == 0) {
                                        ...
                                        <div class="modal fade" id="kt_modal_edit_user<?php echo $sno; ?>" tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-body scroll-y">
                                                    <!--begin::Form-->
                                                    <form id="kt_modal_edit_user_form" method="post" class="form" action="<?php echo base_url('master/department/update/'.$row->iDepartmentId)?>">
                                                        <!--begin::Scroll-->
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="department_name" class="form-control form-control-solid mb-3 mb-lg-0"  value="<?php echo $row->vDepartmentName ?>"/>
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y">
                <form id="kt_modal_add_user_form" method="post" class="form" action="<?php echo base_url();?>master/department/save_data/">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Deprtment</label>
