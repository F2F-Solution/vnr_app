                        ...
                        <div class="card-p position-relative">
                                <div class="row g-0">
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <a href="<?php echo base_url('master/police_officer') ?>" class="text-warning fw-bold fs-6">Police officers</a>
                                        <span class="badge badge-light-warning fs-8 fw-bolder"><?php echo count($policeofficer)?></span>
                                    </div>
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <a href="<?php echo base_url('lockedhome/Lockedhome') ?>" class="text-primary fw-bold fs-6">Locked home</a>
                                        <span class="badge badge-light-primary fs-8 fw-bolder"><?php echo count($lockedhome)?></span>
                                    </div>
                                </div>
                                <div class="row g-0">
                                    <div class="col bg-light-danger px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <a href="<?php echo base_url('policestation/police_station') ?>" class="text-danger fw-bold fs-6 mt-2">Police Station</a>
                                        <span class="badge badge-light-danger fs-8 fw-bolder"><?php echo count($policestation)?></span>
                                    </div>
