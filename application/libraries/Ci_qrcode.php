...
class Ci_qrcode
{
	...
	public function initialize($config = array()) {
		...
		include "qrcode_v1/qrconst.php";
		include "qrcode_v1/qrtools.php";
		include "qrcode_v1/qrspec.php";
		include "qrcode_v1/qrimage.php";
		include "qrcode_v1/qrinput.php";
		include "qrcode_v1/qrbitstream.php";
		include "qrcode_v1/qrsplit.php";
		include "qrcode_v1/qrrscode.php";
		include "qrcode_v1/qrmask.php";
		include "qrcode_v1/qrencode.php";
	}
